...
Gereksinimler:
  ...
  Model indirilmiş olmalı: ollama pull gpt-oss:20b

Kullanım:
  python profil_maker_gptoss.py --input /path/to/logs --output /path/to/output
  python profil_maker_gptoss.py --input /path/to/logs --output /path/to/output --model gpt-oss:20b
"""
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Örnekler:
  # Varsayılan (GPT-OSS 20B, Ollama)
  python profil_maker_gptoss.py --input ./logs --output ./analyzed

  # Farklı model
  python profil_maker_gptoss.py --input ./logs --output ./analyzed --model gpt-oss:20b

  # Farklı endpoint (LM Studio, vLLM vb.)
  python profil_maker_gptoss.py --input ./logs --output ./analyzed --endpoint http://localhost:1234/v1

  # Tek dosya
  python profil_maker_gptoss.py --input ./logs/session1.json --output ./analyzed
        """,
    )
    ...
    parser.add_argument("--model", "-m", default="gpt-oss:20b",
                        help="Model adı (varsayılan: gpt-oss:20b)")
