...
Gereksinimler:
  ...
  Model indirilmiş olmalı: ollama pull qwen2.5:1.5b

Kullanım:
  python pam_analyzer_v3.py --input /path/to/logs --output /path/to/output
  python pam_analyzer_v3.py --input /path/to/logs --output /path/to/output --model qwen2.5:3b
"""
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Örnekler:
  # Varsayılan (Qwen 2.5 1.5B, Ollama)
  python pam_analyzer_v3.py --input ./logs --output ./analyzed

  # Farklı model
  python pam_analyzer_v3.py --input ./logs --output ./analyzed --model qwen2.5:3b

  # Farklı endpoint (LM Studio, vLLM vb.)
  python pam_analyzer_v3.py --input ./logs --output ./analyzed --endpoint http://localhost:1234/v1

  # Tek dosya
  python pam_analyzer_v3.py --input ./logs/session1.json --output ./analyzed
        """,
    )
    ...
    parser.add_argument("--model", "-m", default="qwen2.5:1.5b",
                        help="Model adı (varsayılan: qwen2.5:1.5b)")
