...
Gereksinimler:
  ...
  Model indirilmiş olmalı: ollama pull llama3.1:8b

Kullanım:
  python profil_maker_llama.py --input /path/to/logs --output /path/to/output
  python profil_maker_llama.py --input /path/to/logs --output /path/to/output --model llama3.1:8b
"""
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Örnekler:
  # Varsayılan (Llama 3.1 8B, Ollama)
  python profil_maker_llama.py --input ./logs --output ./analyzed

  # Farklı model
  python profil_maker_llama.py --input ./logs --output ./analyzed --model llama3.1:8b

  # Farklı endpoint (LM Studio, vLLM vb.)
  python profil_maker_llama.py --input ./logs --output ./analyzed --endpoint http://localhost:1234/v1

  # Tek dosya
  python profil_maker_llama.py --input ./logs/session1.json --output ./analyzed
        """,
    )
    ...
    parser.add_argument("--model", "-m", default="llama3.1:8b",
                        help="Model adı (varsayılan: llama3.1:8b)")
